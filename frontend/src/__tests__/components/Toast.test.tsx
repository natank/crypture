...
describe('Toast Components', () => {
  describe('SuccessToast', () => {
    ...
    it('applies visible class when visible prop is true', () => {
      const { container } = render(<SuccessToast message="Test" visible={true} />);
    ...
    it('applies hidden class when visible prop is false', () => {
      const { container } = render(<SuccessToast message="Test" visible={false} />);
  ...
  describe('ErrorToast', () => {
    ...
    it('applies visible class when visible prop is true', () => {
      const { container } = render(<ErrorToast message="Test" visible={true} />);
  ...
  describe('WarningToast', () => {
    ...
    it('applies visible class when visible prop is true', () => {
      const { container } = render(<WarningToast message="Test" visible={true} />);
