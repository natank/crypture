...
describe('portfolioAnalyticsService', () => {
    ...
    describe('calculateAssetAllocation', () => {
        ...
        it('should handle missing prices', () => {
            ...
            const result = calculateAssetAllocation(mockPortfolio, incompletePriceMap);
    ...
    describe('calculateCategoryAllocation', () => {
        it('should distribute value across categories', () => {
            const result = calculateCategoryAllocation(mockPortfolio, mockPriceMap, mockMetadata);
        ...
        it('should handle missing metadata', () => {
            const result = calculateCategoryAllocation(mockPortfolio, mockPriceMap, {});
    ...
    describe('calculateMarketCapAllocation', () => {
        it('should group by market cap tier', () => {
            const result = calculateMarketCapAllocation(mockPortfolio, mockPriceMap, mockMetadata);
        ...
        it('should handle different tiers', () => {
            ...
            const result = calculateMarketCapAllocation(mockPortfolio, mockPriceMap, mixedMetadata);
    ...
    describe('calculateRiskAllocation', () => {
        it('should classify risk levels correctly', () => {
            const result = calculateRiskAllocation(mockPortfolio, mockPriceMap, mockMetadata);
