...
describe('useTrendingCoins', () => {
    ...
    it('should fetch and return trending coins successfully', async () => {
        (coinService.fetchTrendingCoins as any).mockResolvedValue(mockTrendingCoins);
    ...
    it('should handle errors when fetching trending coins', async () => {
        ...
        (coinService.fetchTrendingCoins as any).mockRejectedValue(new Error(errorMessage));
