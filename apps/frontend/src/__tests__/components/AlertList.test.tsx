...
describe('AlertList', () => {
  ...
  it('displays alert coin symbol and target price', () => {
    render(<AlertList alerts={[mockActiveAlert]} title="Active Alerts" />);
  ...
  it('displays correct condition symbol for below', () => {
    render(
      <AlertList alerts={[mockTriggeredAlert]} title="Triggered Alerts" />
    );
  ...
  it('displays muted status badge', () => {
    render(<AlertList alerts={[mockMutedAlert]} title="Muted Alerts" />);
  ...
  it('does not show mute option for muted alerts', () => {
    ...
    const muteMenuItem = menuItems.find((btn) =>
  ...
  it('formats small prices with more decimal places', () => {
    ...
    render(<AlertList alerts={[smallPriceAlert]} title="Active Alerts" />);
