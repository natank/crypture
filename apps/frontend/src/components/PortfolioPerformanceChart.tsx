        ...
        <div>
          ...
          {!loading && !error && history.length > 0 && (
            <div className="flex items-baseline gap-3 mt-1">
              ...
              <div
                className={`flex items-center text-sm font-medium ${metrics.change >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
                <span data-testid="portfolio-value-change">
                  {metrics.change >= 0 ? '+' : ''}
                  {formatCurrency(metrics.change)}
                </span>
                <span className="mx-1">•</span>
                <span data-testid="portfolio-percent-change">
