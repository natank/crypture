...
test.describe('Price Alerts - Panel Management', () => {
  ...
  test('opens alerts panel when clicking bell icon', async ({ page }) => {
    ...
    const alertsPanel = page.locator(
      '[role="dialog"][aria-label="Price Alerts"]'
    );
  ...
  test('closes alerts panel when clicking backdrop', async ({ page }) => {
    ...
    await page
      .locator('[data-testid="alerts-backdrop"]')
      .click({ force: true });
    await expect(alertsPanel).not.toBeVisible({ timeout: 3000 });
  });
...
test.describe('Price Alerts - Creating Alerts', () => {
  ...
  test("creates a price alert with 'below' condition", async ({ page }) => {
    ...
    await alertsPanel
      .getByRole('button', { name: /ethereum/i })
      .first()
      .click();
  ...
  test('shows validation error for missing coin selection', async ({
    page,
  }) => {
    await page.goto('/portfolio');
  ...
  test('cancels alert creation', async ({ page }) => {
    ...
    await expect(
      alertsPanel.getByRole('button', { name: /create alert/i })
    ).toBeVisible();
  });
});
...
test.describe('Price Alerts - Managing Alerts', () => {
  ...
  test('shows delete confirmation modal when deleting alert (KI-02)', async ({
    page,
  }) => {
    ...
    const confirmModal = page.locator(
      '[role="dialog"][aria-labelledby="delete-alert-modal-title"]'
    );
  ...
  test('cancels alert deletion from confirmation modal (KI-02)', async ({
    page,
  }) => {
  ...
  test('cancels alert deletion by clicking backdrop (KI-02)', async ({
    page,
  }) => {
    // Seed alert with correct format
    await page.goto('/portfolio');
  ...
  test('confirms and deletes alert from confirmation modal (KI-02)', async ({
    page,
  }) => {
    // Seed alerts with correct format
    await page.goto('/portfolio');
  ...
  test('mutes an alert', async ({ page }) => {
    ...
    await expect(
      alertsPanel.getByRole('heading', { name: /Muted/i })
    ).toBeVisible();
  });
  ...
  test('reactivates a muted alert', async ({ page }) => {
    ...
    await expect(
      alertsPanel.getByRole('heading', { name: /Active Alerts/i })
    ).toBeVisible();
    await expect(
      alertsPanel
        .locator('[data-testid="alert-item"]')
...
test.describe('Price Alerts - Badge Count', () => {
  ...
  test('updates badge when alert is deleted', async ({ page }) => {
    ...
    await expect(alertsPanel.locator('[data-testid="alert-item"]')).toHaveCount(
      1
    );
  ...
  test('updates badge immediately when alert is created (KI-01)', async ({
    page,
  }) => {
  ...
  test('updates badge immediately when alert is deleted (KI-01)', async ({
    page,
  }) => {
    // Seed 2 alerts
    await page.goto('/portfolio');
...
test.describe('Price Alerts - Persistence', () => {
  ...
  test('alerts persist after page reload', async ({ page }) => {
    ...
    await page.getByRole('button', { name: /alerts/i }).click();
    const alertsPanelAfterReload = page.locator(
      '[role="dialog"][aria-label="Price Alerts"]'
    );
