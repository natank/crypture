...
test.describe("Export Portfolio Feedback", () => {
  ...
  test("exports portfolio successfully with download", async ({ page }) => {
    ...
    await modal.locator("select#asset-select").selectOption({ label: "Ethereum (ETH)" });
  ...
  test("shows warning toast when trying to export empty portfolio", async ({ page }) => {
    await page.goto("/portfolio");
...
test.describe("Import Portfolio Feedback", () => {
  ...
  test("shows preview modal with summary counts before import", async ({ page }) => {
    await page.goto("/portfolio");
  ...
  test("shows single success toast after merge (not individual toasts)", async ({ page }) => {
    await page.goto("/portfolio");
  ...
  test("shows warning toast for partial success with skipped count", async ({ page }) => {
    await page.goto("/portfolio");
...
test.describe("Import/Export Edge Cases", () => {
  ...
  test("merge operation updates existing assets correctly", async ({ page }) => {
    await page.goto("/portfolio");
