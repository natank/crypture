...
const features = [
  ...
  },
  {
    ...
    description:
      'Easily track all your crypto assets in one place with beautiful charts.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Track your investment performance with detailed profit/loss calculations.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Your data stays on your device. We never store your private keys.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'View historical price data and performance metrics for all your assets.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Personalize your dashboard to show the information that matters most to you.',
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              >
                <span className="mr-2">✨</span> Now with real-time price
                updates
              </motion.div>
              ...
              >
                Simple, beautiful, and powerful cryptocurrency portfolio tracker
                with real-time updates and advanced analytics.
              </motion.p>
            ...
            >
              <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0">
                ...
                <div className="relative overflow-hidden rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700">
                  <picture>
                    <source
                      srcSet="/images/screenshots/dashboard-preview.webp"
                      type="image/webp"
                    />
                    <source
                      srcSet="/images/screenshots/dashboard-preview.png"
                      type="image/png"
                    />
                    <img
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-b from-transparent to-gray-900/5"
                    aria-hidden="true"
                  ></div>
                </div>
              </div>
      ...
      <section id="features" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Powerful features to help you manage your cryptocurrency
              investments.
            </motion.p>
          </div>
